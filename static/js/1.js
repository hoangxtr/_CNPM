...
function show_menu(tab) {
  ...
  for (var r = 0; r < 3; r ++) {
    ...
    for (var i = 0; i < 4; i ++) {
      ...
      p2_tag = document.createElement('p');
      p2_tag.setAttribute('style', "white-space: normal; word-break: break-all;")
      p2_tag.innerHTML = food.price + ' VND';
      ...
      info_tag.innerHTML = h4_tag.outerHTML + p_tag.outerHTML + p2_tag.outerHTML + span_tag.outerHTML;
